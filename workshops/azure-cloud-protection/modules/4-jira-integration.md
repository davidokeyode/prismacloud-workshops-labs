...
![jira-app-link-config](../images/4-jira-app-link-config.png)
...
![jira-integrate-config](../images/4-jira-integrate-config.png)
...
![prisma-jira-template](../images/4-prisma-jira-template.png)
